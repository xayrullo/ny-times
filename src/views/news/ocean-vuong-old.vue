<template>
  <div class="absolute sections top-0">
    ...
    <section
      class="absolute third-section h-screen flex items-center bg-white z-10 opacity-0 inset-0"
    >
      <div class="relative flex items-center">
        ...
        <div class="absolute opacity-0 inset-0 third-section-night-house-image">
          <img
...
onMounted(() => {
  ...
  tl.to(".top-first-text", { autoAlpha: 0, duration: 1 })
    ...
    .to(".third-section-text", { opacity: 1, duration: 2 })
    .fromTo(
      ".second-section-text",
      { y: "100vh", opacity: 0 },
      {
        ...
        onUpdate: function () {
          ...
          if (progress === 1) {
            ...
            gsap.set(".second-section-night-house-image", {
              opacity: 1,
              duration: 3,
            });
          }
          if (progress > 0.45) {
            gsap.set(".second-section-image", { opacity: 1 - progress });
          } else if (progress > 0.3) {
            gsap.set(".second-section-image", { opacity: 1 });
          }
        },
      },
      ">-0.1"
    )
    .to(".third-section", { opacity: 1, duration: 1 })
    .fromTo(
      ".third-section-text",
      { y: "100vh", opacity: 0 },
      {
        ...
        onUpdate: function () {
          const progress = this.progress();
          if (progress === 1) {
            gsap.set(".third-section", { opacity: 0 });
          }
          if (progress > 0.45) {
    ...
    .to(".fourth-section", { opacity: 1, duration: 1 });
});
</script>
